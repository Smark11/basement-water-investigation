...
### 18:15 — Deep vetting (4 parallel agents: license roster, business registry, BBB, review mining, litigation search)
- Method: HIC registrations checked against the state's open-data mirror of the DCP eLicense roster (data.ct.gov); LLC/corp status via the CT Secretary of the State registry datasets; BBB complaint tabs read directly; negative reviews actively hunted; litigation searched (CT Judicial party search is interactive-only, so that check is strong-but-not-exhaustive everywhere).
- **Gibson Cellar Door — PASS W/ NOTES.** HIC 0635611 Active (exp 3/31/2027, name match); LLC active (2018, veteran-owned); BBB A+ zero complaints; no litigation. Notes: contract should name "Gibson Cellar Door LLC"; modest/older review volume; COI at quote time.
- **J.C. Tonnotti — PASS W/ NOTES.** HIC 0614190 Active (exp 3/31/2027); corporation active, family officers verified; BBB A+ zero complaints/3yrs; ~570 reviews 4.7 w/ late-2025 recency; ~600 permits. Notes: "since 1979" company-claimed (records to 1999); bulkheads a smaller line — ask for trade-specific reference + brand.
- **Dino & Rocco's — PASS W/ NOTES.** HIC 0647875 Active (exp 3/31/2027); LLC active but 2017 (owner's registrations trace to 1990s); zero complaints; good review recency. Notes: two predecessor entities forfeited (unfiled annual reports); BBB file opened May 2025; thin independent corroboration; lifetime warranty durability = LLC durability.
- **CT Cellar Doors — PASS W/ NOTES.** HIC 0644013 Active; LLC active since 2003; BBB A+ only 1 complaint/3yrs vs ~265 reviews at 4.6. Characterized failure mode: post-deposit delays + subcontracted finish work (incl. unresolved Aug 2024 review). Mitigations: employees-vs-subs, delivery window + dates in contract pre-deposit, permit/final-inspection commitment.
